...
const styles = {
  ...
  input: {
    ...
    fontSize: '14px', fontFamily: 'var(--font)', color: 'var(--ink)', background: 'var(--cream)',
  ...
  clientName: { fontWeight: '600', fontSize: '14px', color: 'var(--ink)' },
  clientSub: { fontSize: '12px', color: '#888', marginTop: '2px' },
  divider: {
    textAlign: 'center', fontSize: '12px', color: '#aaa', margin: '16px 0',
    borderTop: '1px solid var(--border)', paddingTop: '12px',
  },
  clientPill: { fontSize: '13px', color: 'var(--ink)', marginBottom: '14px', background: 'var(--terra-wash)', padding: '8px 12px', borderRadius: '8px' },
  linkBtn: { background: 'none', border: 'none', color: 'var(--terra)', fontSize: '13px', cursor: 'pointer', fontFamily: 'var(--font)', fontWeight: '600' },
  primaryBtn: {
    background: 'var(--terra)', color: '#fff', border: 'none', borderRadius: '8px',
    padding: '10px 20px', fontSize: '14px', fontWeight: '600', cursor: 'pointer', fontFamily: 'var(--font)',
  },
  ghostBtn: {
    background: 'none', border: '1px solid var(--border)', borderRadius: '8px',
    padding: '10px 16px', fontSize: '14px', color: 'var(--ink)', cursor: 'pointer', fontFamily: 'var(--font)',
  },
  ...
  catLabel: { fontSize: '15px', fontWeight: '700', color: 'var(--ink)' },
  catDesc: { fontSize: '12px', color: '#888', marginTop: '2px' },
  catArrow: { color: 'var(--terra)', fontSize: '16px', fontWeight: '700' },
}
