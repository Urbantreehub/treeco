...
const s = {
  ...
  secNavTitle: { fontSize:16, fontWeight:800, color:'var(--ink)' },
  body: {},
  ...
  statNum: { fontSize: 26, fontWeight: 800, color: 'var(--ink)' },
  ...
  rowTitle: { fontSize: 14, fontWeight: 600, color: 'var(--ink)', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' },
...
const SECTIONS = [
  ...
  { key:'sop',         icon:'📝', label:'SOPs',                    desc:'Standard Operating Procedures — 17 documents' },
  { key:'assessments', icon:'⚠️',  label:'Risk Assessments',       desc:'Site and task risk assessments' },
  { key:'training',    icon:'📋', label:'Training Register',       desc:'Staff qualifications and certification status' },
