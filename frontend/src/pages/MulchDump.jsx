...
const mstyle = {
  ...
  addBtn: { padding: '9px 16px', borderRadius: '9px', border: 'none', background: 'var(--terra)', color: '#fff', fontSize: '14px', fontWeight: '700', cursor: 'pointer', fontFamily: 'var(--font)' },
  ...
  siteRowActive: { background: 'var(--terra-wash)' },
  siteName: { fontSize: '14px', fontWeight: '700', color: 'var(--ink)', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' },
  ...
  detailName: { fontSize: '20px', fontWeight: '700', color: 'var(--ink)' },
  ...
  cardText: { fontSize: '14px', color: 'var(--ink)', lineHeight: 1.5, whiteSpace: 'pre-wrap' },
  ...
  price: { fontSize: '22px', fontWeight: '800', color: 'var(--terra)' },
  ...
  logBtn: { width: '100%', padding: '16px', borderRadius: '12px', border: 'none', background: 'var(--terra)', color: '#fff', fontSize: '16px', fontWeight: '700', cursor: 'pointer', fontFamily: 'var(--font)', marginBottom: '20px', boxShadow: '0 2px 8px rgba(74,103,65,0.3)' },
  logCard: { background: '#fff', border: '1.5px solid var(--terra)', borderRadius: '12px', padding: '16px', marginBottom: '20px' },
  logHint: { fontSize: '12px', color: '#888', marginBottom: '10px', lineHeight: 1.4 },
  textarea: { width: '100%', padding: '10px 12px', borderRadius: '8px', border: '1.5px solid var(--border)', fontSize: '14px', fontFamily: 'var(--font)', color: 'var(--ink)', outline: 'none', boxSizing: 'border-box', resize: 'vertical', marginBottom: '8px' },
  ...
  confirmBtn: { flex: 1, padding: '12px', borderRadius: '9px', border: 'none', background: 'var(--terra)', color: '#fff', fontSize: '14px', fontWeight: '700', cursor: 'pointer', fontFamily: 'var(--font)' },
  ...
  dumpTop: { fontSize: '13px', fontWeight: '600', color: 'var(--ink)' },
  ...
  modalTitle: { fontSize: '17px', fontWeight: '700', color: 'var(--ink)' },
  ...
  input: { width: '100%', padding: '10px 12px', borderRadius: '8px', border: '1.5px solid var(--border)', fontSize: '14px', fontFamily: 'var(--font)', color: 'var(--ink)', outline: 'none', boxSizing: 'border-box' },
  ...
  toast: { position: 'fixed', bottom: '80px', left: '50%', transform: 'translateX(-50%)', background: 'var(--ink)', color: '#fff', padding: '11px 20px', borderRadius: '10px', fontSize: '14px', fontWeight: '600', boxShadow: '0 4px 16px rgba(0,0,0,0.25)', zIndex: 700, maxWidth: '90vw', textAlign: 'center' },
}
