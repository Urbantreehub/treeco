...
const s = {
  ...
  cardTitle: { fontSize: '13px', fontWeight: '700', color: 'var(--ink)', marginBottom: '12px' },
  ...
  kindBtnActive: { borderColor: 'var(--terra)', background: 'var(--terra-wash)', color: 'var(--terra)' },
  input: { width: '100%', padding: '11px 12px', borderRadius: '8px', border: '1.5px solid var(--border)', fontSize: '14px', fontFamily: 'var(--font)', color: 'var(--ink)', outline: 'none', boxSizing: 'border-box', marginBottom: '10px' },
  textarea: { width: '100%', padding: '11px 12px', borderRadius: '8px', border: '1.5px solid var(--border)', fontSize: '14px', fontFamily: 'var(--font)', color: 'var(--ink)', outline: 'none', boxSizing: 'border-box', resize: 'vertical', marginBottom: '10px' },
  ...
  submitBtn: { padding: '11px 22px', borderRadius: '9px', border: 'none', background: 'var(--terra)', color: '#fff', fontSize: '14px', fontWeight: '700', cursor: 'pointer', fontFamily: 'var(--font)' },
  ...
  filterChipActive: { background: 'var(--ink)', color: '#fff', borderColor: 'var(--ink)' },
  ...
  reqItem: { fontSize: '16px', fontWeight: '700', color: 'var(--ink)', marginBottom: '3px' },
  ...
  actionBtn: { padding: '8px 14px', borderRadius: '8px', border: '1.5px solid var(--terra)', background: '#fff', color: 'var(--terra)', fontSize: '13px', fontWeight: '600', cursor: 'pointer', fontFamily: 'var(--font)' },
  actionBtnDanger: { borderColor: '#E0B0AA', color: 'var(--danger)' },

  toast: { position: 'fixed', bottom: '80px', left: '50%', transform: 'translateX(-50%)', background: 'var(--ink)', color: '#fff', padding: '11px 20px', borderRadius: '10px', fontSize: '14px', fontWeight: '600', boxShadow: '0 4px 16px rgba(0,0,0,0.25)', zIndex: 500 },
}
