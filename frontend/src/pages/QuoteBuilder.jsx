...
const pv = {
  ...
  page: { flex: 1, overflowY: 'auto', padding: '32px 20px 60px' },
  doc: { maxWidth: '780px', margin: '0 auto', background: '#fff', borderRadius: '4px', boxShadow: '0 4px 24px rgba(0,0,0,0.12)', overflow: 'hidden' },
