...
const s = {
  ...
  title: { fontSize: '22px', fontWeight: '800', color: 'var(--ink)', margin: '0 0 6px', textAlign: 'center' },
  ...
  input: { width: '100%', padding: '12px 13px', borderRadius: '9px', border: '1.5px solid var(--border)', fontSize: '15px', fontFamily: 'var(--font)', color: 'var(--ink)', outline: 'none', boxSizing: 'border-box' },
  textarea: { width: '100%', padding: '12px 13px', borderRadius: '9px', border: '1.5px solid var(--border)', fontSize: '15px', fontFamily: 'var(--font)', color: 'var(--ink)', outline: 'none', boxSizing: 'border-box', resize: 'vertical', marginBottom: '2px' },
