...
## 6. Schedule the sender (optional)

Only needed if you want to schedule campaigns for a future time. Same pattern as
`sweep-stale-quotes` in migration 035:

```sql
select cron.schedule(
  'campaign-scheduler', '*/15 * * * *',
  $$ select net.http_post(
       url     := 'https://<project>.supabase.co/functions/v1/campaign-scheduler',
